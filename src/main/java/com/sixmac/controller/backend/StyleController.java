...
public class StyleController extends CommonController {
    ...
    @ResponseBody
    public Integer delete(HttpServletRequest request, Integer styleId) {
        try {
            stylesService.deleteById(request, styleId);
    ...
    public Integer save(HttpServletRequest request,
        ...
        try {
            ...
            operatisService.addOperatisInfo(request, null == id ? "新增" : "修改" + "风格分类 " + style.getName());
