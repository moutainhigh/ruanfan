...
public class IdenCode extends HttpServlet {
    ...
    public static void getIdenCode(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getSession().setAttribute("code", sb1);
        // 将图片以流的形式输出
