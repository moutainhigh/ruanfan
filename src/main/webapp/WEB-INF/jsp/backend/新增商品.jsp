            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="productForm" method="post" action="backend/product/save" class="form-horizontal nice-validator n-default" role="form" novalidate="novalidate">
        ...
        fn: {
            ...
            subInfo: function () {
                ...
                if (product.fn.checkData()) {
                    $.post(_basePath + "backend/product/save",
                            {
                                "id": $('#productId').val(),
                                "name": $('#name').val(),
                                "price": $('#price').val(),
                            ...
                            function (data) {
                                if (data > 0) {
                                    window.location.href = _basePath + "backend/product/index";
                                } else {
            ...
            goBack: function () {
                window.location.href = "backend/product/index";
            }
        }
    }
