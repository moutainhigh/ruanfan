    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h4 style="margin-left: 10px;">——杂志列表</h4>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="backend/magazine/add" class="btn btn-outline btn-primary btn-lg" role="button">新增杂志</a>
    ...
    var magazineList = {
        ...
        fn: {
            ...
            dataTableInit: function () {
                magazineList.v.dTable = $sixmac.dataTable($('#dataTables'), {
                    ...
                    rowCallback: function (row, data) {
                        ...
                        $('td', row).last().find(".edit").attr("href", 'backend/magazine/add?id=' + data.id);
            ...
            subInfo: function () {
                ...
                $sixmac.ajax("backend/magazine/delete", {
