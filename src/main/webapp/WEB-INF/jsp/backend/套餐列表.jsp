            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="backend/packages/add" class="btn btn-outline btn-primary btn-lg" role="button">新增套餐</a>
    ...
    var packagesList = {
        ...
        fn: {
            ...
            dataTableInit: function () {
                packagesList.v.dTable = $sixmac.dataTable($('#dataTables'), {
                    ...
                    rowCallback: function (row, data) {
                        ...
                        $('td', row).last().find(".edit").attr("href", 'backend/packages/add?id=' + data.id);
            ...
            subDelInfo: function () {
                ...
                $sixmac.ajax("backend/packages/delete", {
