    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h4 style="margin-left: 10px;">——秒杀商品列表</h4>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="backend/spikes/add" class="btn btn-outline btn-primary btn-lg" role="button">新增秒杀</a>
    ...
    var spikeList = {
        ...
        fn: {
            ...
            dataTableInit: function () {
                spikeList.v.dTable = $sixmac.dataTable($('#dataTables'), {
                    ...
                    rowCallback: function (row, data) {
                        ...
                        $('td', row).last().find(".edit").attr("href", 'backend/spikes/add?id=' + data.id);
            ...
            subInfo: function () {
                ...
                $sixmac.ajax("backend/spikes/delete", {
                    "spikeId": spikeId,
                }, function (result) {
                    if (result == 1) {
