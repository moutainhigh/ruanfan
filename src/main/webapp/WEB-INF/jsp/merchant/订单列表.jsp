    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h4 style="margin-left: 10px;">——商品订单列表</h4>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading" style="height:75px;">
                        ...
                        <form class="navbar-form navbar-right" role="search">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="productName" maxlength="20"
                                       placeholder="商品名称"/>
                            </div>
                            <div class="form-group">
                                <label>状态：</label>
            ...
            dataTableInit: function () {
                ordersList.v.dTable = $sixmac.dataTable($('#dataTables'), {
                    ...
                    rowCallback: function (row, data) {
                        $('td', row).last().find(".edit").attr("href", 'merchant/orders/detail?id=' + data.id);
