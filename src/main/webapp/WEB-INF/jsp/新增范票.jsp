            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="couponForm" method="post" enctype="multipart/form-data" action="coupon/save" class="form-horizontal nice-validator n-default" role="form" novalidate="novalidate">
                ...
                if (coupon.fn.checkData()) {
                    $("#couponForm").ajaxSubmit({
                        ...
                        success: function (result) {
                            if (result > 0) {
                                window.location.href = _basePath + "coupon/index";
                            } else {
