        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="infoForm" method="post" action="virtualType/save" class="form-horizontal" role="form">
    ...
    var virtualTypeList = {
        ...
        fn: {
            ...
            subDelInfo: function () {
                ...
                $sixmac.ajax("virtualType/delete", {
            ...
            subInfo: function () {
                ...
                if (flag) {
                    $("#infoForm").ajaxSubmit({
                        url: _basePath + "virtualType/save",
                        dataType: "json",
                        data: {
                            "id": virtualTypeId,
                            "name": productName
