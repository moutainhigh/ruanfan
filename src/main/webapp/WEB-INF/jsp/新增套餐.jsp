            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="packagesForm" method="post" action="packages/save" class="form-horizontal nice-validator n-default" role="form" novalidate="novalidate">
            ...
            subInfo: function () {
                ...
                if (packages.fn.checkData()) {
                    $.post(_basePath + "packages/save",
                            ...
                            function (data) {
                                if (data > 0) {
                                    window.location.href = _basePath + "packages/index";
                                } else {
