            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="designersForm" method="post" enctype="multipart/form-data" action="designers/save" class="form-horizontal nice-validator n-default" role="form" novalidate="novalidate">
...
<script type="text/javascript">
    var designers = {
        ...
        fn: {
                ...
                if (designers.fn.checkData()) {
                    $("#designersForm").ajaxSubmit({
                        ...
                        success: function (result) {
                            if (result > 0) {
                                window.location.href = _basePath + "designers/index";
                            } else {
            ...
            goBack: function () {
                window.location.href = "designers/index";
            }
        }
    }
