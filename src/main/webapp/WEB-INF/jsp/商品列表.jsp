            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="product/add" class="btn btn-outline btn-primary btn-lg" role="button">新增商品</a>
    ...
    var masterProductList = {
        ...
        fn: {
            ...
            subCheckInfo: function () {
                ...
                if (flag) {
                    $sixmac.ajax("product/changeCheck", {
                        "productId": id,
                        "isCheck": 2,
                        "reason": reason
                    }, function (result) {
            ...
            changeStatus: function (id, status) {
                $sixmac.ajax("product/changeStatus", {
                    "productId": id,
                    "status": status
                }, function (result) {
                    if (result == 1) {
