            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="propertyInfoForm" method="post" enctype="multipart/form-data" action="propertys/addChildInfo" class="form-horizontal nice-validator n-default" role="form" novalidate="novalidate">
    ...
    var propertyInfo = {
        ...
        fn: {
            ...
            goBack: function () {
                ...
                window.location.href = 'propertys/childInfo?id=' + parentId;
            }
        }
    }
