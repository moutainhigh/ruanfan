            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="virtualsForm" method="post" enctype="multipart/form-data" action="virtuals/save" class="form-horizontal" role="form">
...
<script type="text/javascript">
    var virtuals = {
        ...
        fn: {
                ...
                if (flag) {
                    $("#virtualsForm").ajaxSubmit({
                        ...
                        success: function (result) {
                            if (result > 0) {
                                window.location.href = _basePath + "virtuals/index";
                            } else {
            ...
            goBack: function () {
                window.location.href = "virtuals/index";
            }
        }
    }
