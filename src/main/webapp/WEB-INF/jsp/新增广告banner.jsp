            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="bannerForm" method="post" enctype="multipart/form-data" action="banner/save" class="form-horizontal" role="form">
                ...
                if (flag) {
                    $("#bannerForm").ajaxSubmit({
                        ...
                        success: function (result) {
                            if (result > 0) {
                                window.location.href = _basePath + "banner/index";
                            } else {
