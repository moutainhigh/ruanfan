                    ...
                    <div class="panel-body">
                        <form id="productForm" method="post" enctype="multipart/form-data" action="admin/product/save" class="form-horizontal" role="form">
                            ...
                            <div class="form-group img_tooltip" >
                                ...
                                <div class="col-sm-3">
                                    <input type="hidden" id="imageId" name="imageId" value="${product.image.id}">


                                    <div class="image_show"  <c:if test="${product.image==null}"> style="display: none"  </c:if>>
                                        <img src="${product.image.path}" class='img-responsive' >
                                    </div>
                                    <div class="image_handle"  <c:if test="${product.image!=null}">  style="display: none"  </c:if>data-toggle="tooltip" data-placement="top" title="" data-original-title="建议上传宽480px高320px的图片">
