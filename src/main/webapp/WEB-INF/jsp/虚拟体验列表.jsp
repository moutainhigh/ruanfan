            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="virtuals/add" class="btn btn-outline btn-primary btn-lg" role="button">新增VR虚拟</a>
            ...
            dataTableInit: function () {
                virtualsList.v.dTable = $sixmac.dataTable($('#dataTables'), {
                    ...
                    rowCallback: function (row, data) {
                        ...
                        $('td', row).last().find(".edit").attr("href", 'virtuals/add?id=' + data.id);
