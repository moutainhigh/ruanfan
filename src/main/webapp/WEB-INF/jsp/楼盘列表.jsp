            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a href="propertys/index" class="btn btn-outline btn-success btn-lg" role="button">返回</a>
                    </div>
                    <!-- /.panel-heading -->
...
<script type="text/javascript">
    ...
    var propertyList = {
        ...
        fn: {
            ...
            toAdd: function () {
                var parentId = $('#parentId').val();
                window.location.href = 'propertys/addChild?parentId=' + parentId;
            }
        }
    }
