            ...
            <div class="modal-body">
                <form id="pwdForm" method="post" action="modifyPwd" class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="password" class="form-control" id="oldPwd" name="oldPwd" data-rule="required;length[6~]" placeholder="请输入旧密码">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="submit">
                    ...
                    <p class="text-center"><a href="javascript:void(0)" target="_blank">软范设计师后台管理系统</a></p>
                </div>
            </div>
        </div>
    </div>
