            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="magazineForm" method="post" enctype="multipart/form-data" action="magazine/save" class="form-horizontal" role="form">
    ...
    var magazine = {
        ...
        fn: {
            ...
            insertImage: function (path, id) {
                ...
                tempDiv.children(":first").next().next().next().prop("href", "magazine/addTempLabel?id=" + id);
                ...
                if (flag) {
                    $("#magazineForm").ajaxSubmit({
                        ...
                        success: function (result) {
                            if (result > 0) {
                                window.location.href = _basePath + "magazine/index";
                            } else {
            ...
            goBack: function () {
                window.location.href = "magazine/index";
            }
        }
    }
